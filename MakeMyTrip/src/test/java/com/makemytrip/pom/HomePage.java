...
public class HomePage extends BaseClass {
	...
	@FindBy(xpath = "//div[@data-cy=\"outsideModal\"]") //added by sathya
	private WebElement ignorePopup;    // added by sathya
	...
	public WebElement getIgnorePopup() {    //added by sathya 
		return ignorePopup;    //added by sathya 
	}
...
//		Actions ac = new Actions(driver);					//Removed by sathya
//		ac.moveToElement(flightsMenu).click().perform();	//Removed by sathya
		flightsMenu.click();
	}

	public void selectRoundtripMenu() throws InterruptedException {
		ignorePopup.click();//added by sathya
		roundTripMenu.click();
	}
