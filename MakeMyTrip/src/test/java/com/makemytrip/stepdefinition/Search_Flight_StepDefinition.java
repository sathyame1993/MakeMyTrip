...
public class Search_Flight_StepDefinition extends BaseClass {
	...
	public void user_selects_the_flight_option_to_travel() throws InterruptedException {
	...
	public void user_checks_on_round_trip_as_option() throws InterruptedException {
		
		hp.selectRoundtripMenu();
		test.log(Status.INFO, "Selected round trip");
	}
	@When("User enter {string} as source city")
	public void user_enter_as_source_city(String Source_city) throws InterruptedException {
		hp.enterDepartureCity(Source_city);
		test.log(Status.INFO, "Entered the departure city");
	}
	@When("User enter {string} as destination city")
	public void user_enter_as_destination_city(String Destination_city) throws InterruptedException {
		hp.enterReturnCity(Destination_city);
		test.log(Status.INFO, "Entered return city");
	}
	@When("User enter the departure date")
	public void user_enter_the_departure_date() throws Exception {
		hp.enterDepartureDate();
		test.log(Status.INFO, "Entered Departure date");
	}
	@When("User enter the return date")
	public void user_enter_the_return_date() throws Exception {
		Thread.sleep(2000);
		hp.enterReturnDate();
	...
	public void user_navigates_to_flight_details_page() {
